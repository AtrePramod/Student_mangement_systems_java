 ...
 * @author PRAMOD
 */
public class opertionframe extends javax.swing.JFrame {

    /**
     * Creates new form opertionframe
     */
    public opertionframe() {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sms01/Microsoft-Windows-10-Wallpaper.jpg"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(4, -6, 1360, 740);
...
sendEmailframe rf=new sendEmailframe();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(opertionframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new opertionframe().setVisible(true);
            }
        });
    }
