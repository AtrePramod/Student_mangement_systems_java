...
public class viewmarksframe extends javax.swing.JFrame {
    ...
    /**
     * Creates new form viewmarksframe
     */public static String data[][];
    public viewmarksframe() {
      super("View Maker Frame");
        initComponents();   //department, sem, name, sub, marks
       String colname[]={"department","sem","name","sub","marks"};
        viewmarksmaker df=new viewmarksmaker();
        df.viewAllmarks();
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(220, 90, 950, 360);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 36)); // NOI18N
        jLabel1.setText("View All Marks");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(610, 50, 240, 30);
