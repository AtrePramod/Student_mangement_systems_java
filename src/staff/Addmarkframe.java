 ...
 * @author PRAMOD
 */
public class Addmarkframe extends javax.swing.JFrame {

    /**
     * Creates new form Entermarkframe
     */
    public Addmarkframe() {
        super("Add marks frame");
        initComponents();
    }
...
String sub=(String) jComboBox4.getSelectedItem();
  ...
  {
   marksmaker mr=new marksmaker();   
      if(mr.insertData(dep, sem, name, sub, marks))
      {
                JOptionPane.showMessageDialog(null,"Marks Add Successfully");
...
System.exit(0);         // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Addmarkframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Addmarkframe().setVisible(true);
            }
        });
    }
