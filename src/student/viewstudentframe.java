...
public class viewstudentframe extends javax.swing.JFrame {
    ...
    public viewstudentframe() {
               super("viewstudentframe"); 
        initComponents();
         String colname[]={"name","Date of birth","emailid","mobile"," department","sem","Id"};
        viewstudentmaker df=new viewstudentmaker();
        df.viewAllstudent();
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(41, 131, 1240, 307);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 36)); // NOI18N
        jLabel1.setText("View All Students");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(490, 80, 280, 30);
